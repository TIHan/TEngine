...
namespace dgp {
  ...
  public:
    ...
    dgpInt receive (dgpByte *pBuffer, const dgpUint nBufferSize);
    dgpInt send (dgpByte *pBuffer, const dgpUint nBufferSize, const dgpChar *szNodeName, const dgpChar *szServiceName);
  };
}
